	...
	<div class="inner">
		...
		<br />
	<div class="page-title" style="float:left"> Paid Platter Orders&nbsp; <span class="title-event-info">Listing of Platters already paid for</span></div> 
  ...
  <tr bgcolor="#29ABE2" style="color:#FFFFFF; font-size:14px;">
      <th width="15px" class="booking-summary-header">Sl.No</th> 
	   ...
	   <th class="booking-summary-header">Customer Details</th> 
	...
	<?php  
	 ...
	 foreach ($paid_bookings as $paid_bookings1):
	   ...
	   $paid_value_date = $date_pieces[2].'-'.$date_pieces[1].'-'.$date_pieces[0];
	
	?>
	<tbody>					
       <tr>						
		<td align="center" style="background: #fff;"><?php echo $i; ?></td>
	 	<td align="center" style="background: #fff;"><?php echo $paid_value_date; ?></td>
		...
		<td align="left" style="background: #fff;">Name:&nbsp;<?php echo $paid_bookings1->cust_name; ?> <br />
		...
		<!--<td align="center" style="background: #fff;"><?php //if($paid_bookings1->payment_status){
		   //echo 'paid'; } ?></td>	-->
		   <td align="center" style="background: #fff;" class="platter_price_modify"><?php echo anchor('admin_onli_plat_ord_sys/edit_paid_cust/'.$paid_bookings1->id,'Modify');?></td>
		   <td align="center" style="background: #fff;" class="platter_price_modify"><?php echo anchor('admin_onli_plat_ord_sys/delete_the_customer/'.$paid_bookings1->id,'Delete',"onclick='javascript: return paid_customer();'");?></td>	
	  </tr>				
	</tbody>
	<?php 
