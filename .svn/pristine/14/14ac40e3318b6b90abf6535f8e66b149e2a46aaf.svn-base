	...
	<div class="inner">
		...
		<?php echo form_open('admin_deck_area_booking/check_available_dates'); ?> <br />
		<table>
			<tr>
		...
		<table>
			<tbody>
			<tr>
				<h4 style="text-align:center; padding-left:53px;"><strong>Select Customer Booking Date</strong></h4>
			</tr>
			<tr>
				<th></th>
			...
			<tr>
				...
				<td>
					...
					<input value="Book Customer" style="width:100px; float:right" tabindex="4" type="submit" onclick="return booking_slot()">
				</td>
			</tr>	
		</tbody>
		</table>
